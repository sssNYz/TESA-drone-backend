...
export default async function mapAreaRoutes(app, _opts) {
...
function makeCreateHandler(kind) {
    return async function createHandler(req, reply) {
...
//# sourceMappingURL=map-areas.js.map